<?php
session_start();
//echo "<pre>DEBUG: User Role = " . htmlspecialchars($_SESSION['role']) . "</pre>";
...
if (strpos($role, "dean") !== false ) {
    $dashboardTitle = "Dean - Rejected Proposals";
    $statusFilter = "rejectedbydean"; // Dean sees proposals they rejected
    ...
    $dashboardTitle = "VC - Rejected Proposals";
    $statusFilter = "rejectedbyvc"; // VC sees proposals they rejected
    $dashboardPage = "uni_dashboards.php";
    $approvedPage = "approved_proposals.php";
    $rejectedPage = "rejected_proposals.php";
    ...
    $statusFilter = "rejectedbycqa"; // VC sees proposals approved by Dean
    $approvedPage = "approved_proposals.php";
    $rejectedPage = "rejected_proposals.php";
...
<div id="main-content" class="main-content">
    ...
    <div class="card">
        <div class="card-header bg-danger text-white">Rejected Proposals</div>
        <div class="card-body">
            <table class="table">
                <tr>
                    <th>Proposal ID</th>
