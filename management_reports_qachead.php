...
$query = "SELECT u.university_id, u.university_name, 
                 ...
                 (SELECT COUNT(*) FROM proposals WHERE proposals.university_id = u.university_id AND (university_visible_status LIKE 'approvedbyqac%' OR status LIKE 'approvedbyqachead_%')) AS approved_proposals,
                 (SELECT COUNT(*) FROM proposals WHERE proposals.university_id = u.university_id AND (status LIKE 'rejectedbyqac%' OR status LIKE 'rejectedbyqachead%')) AS rejected_proposals
          FROM universities u
