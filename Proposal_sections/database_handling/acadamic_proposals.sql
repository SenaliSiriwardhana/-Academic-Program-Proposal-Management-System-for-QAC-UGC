...
(3, 1, 2, 'rejectedbyugchr', '2025-03-08 17:02:06', '2025-04-02 19:41:10', '2025-04-02 19:41:10', NULL),
...
(6, 1, 2, 'rejectedbyvc', '2025-03-08 17:46:41', '2025-03-15 16:24:58', '2025-03-09 04:07:55', NULL),
...
(13, 1, 2, 'submitted', '2025-03-14 18:32:17', '2025-03-15 19:01:24', '2025-03-15 14:31:24', NULL),
...
(6, 'Yes', 'Yes', 'Higher Diploma (SLQF 4)', 'Yes', 'YES...', 'No', 'No', 5, '', '/qac_ugc/Proposal_sections/uploads/1741509453_Application_Summary - 2025-03-09T131834.935.pdf', '', ''),
...
('dww', 'fwef', 'wef', 'ewf', 'wefw', 'efwef', 'wef', 'wefwf', 'few', ' f', 'UGC Z score based selection', '', 50, 'Bachelor Honours Degree', '4', 5, 5, 120, 'Sinhala', 5, 6, '/qac_ugc/Proposal_sections/uploads/1741509290_Application_Summary - 2025-03-09T131234.588.pdf', 'Level 6 (Bachelors Honours - 4 year programme)'),
...
INSERT INTO `proposal_general_info` (`proposal_id`, `degree_name_english`, `degree_name_sinhala`, `degree_name_tamil`, `abbreviated_qualification`, `general_info_id`) VALUES
(1, 'B', 'A', 'A', 'BSc', 1),
(2, 'xssx', 'sxas', 'xsax', 'sax', 2),
(3, 'Bsc (Hons) Software Engineering', 'Bsc (Hons) Software Engineering', 'Bsc (Hons) Software Engineering', 'BSc', 3),
(6, 'fre', 'erferf', 'erfer', 'ff', 4),
...
('Corporate / Strategic Plan of the University', 'dcdc', '2025-03-10', '/qac_ugc/qac_ugc/Proposal_sections/uploads/1741455490_benchmark.pdf', 9, 3, 3),
('Action Plan of the Faculty/Institute/Center/Unit', 'dc', '2025-03-25', '/qac_ugc/qac_ugc/Proposal_sections/uploads/1741455490_cooperate.pdf', 10, 3, 3),
('Senate Approval', 'cd', '2025-03-25', '/qac_ugc/qac_ugc/Proposal_sections/uploads/1741455490_council.pdf', 11, 3, 3),
('Council Approval', 'cd', '2025-03-26', '/qac_ugc/qac_ugc/Proposal_sections/uploads/1741455490_council.pdf', 12, 3, 3),
...
('Corporate / Strategic Plan of the University', 'reg', '0000-00-00', '/qac_ugc/Proposal_sections/uploads/1741509256_Application_Summary - 2025-03-09T131229.261.pdf', 17, 6, 5),
('Action Plan of the Faculty/Institute/Center/Unit', 'reg', '2025-03-20', '/qac_ugc/Proposal_sections/uploads/1741509256_Application_Summary - 2025-03-09T131130.272.pdf', 18, 6, 5),
('Senate Approval', 'rferf', '2025-03-19', '/qac_ugc/Proposal_sections/uploads/1741509256_Application_Summary - 2025-03-09T130933.781.pdf', 19, 6, 5),
('Council Approval', 'erferf', '2025-03-19', '/qac_ugc/Proposal_sections/uploads/1741509256_Application_Summary - 2025-03-09T131130.272.pdf', 20, 6, 5),
...
('Corporate / Strategic Plan of the University', 'sad', '2025-03-12', '/qac_ugc/qac_ugc/Proposal_sections/uploads/1742064039_1739894675_action.pdf', 25, 13, 7),
('Action Plan of the Faculty/Institute/Center/Unit', 'sada', '2025-03-26', '/qac_ugc/qac_ugc/Proposal_sections/uploads/1742064039_1739894675_council.pdf', 26, 13, 7),
('Senate Approval', 'sdsa', '2025-03-20', '/qac_ugc/qac_ugc/Proposal_sections/uploads/1742064039_1739720192_benchmark.pdf', 27, 13, 7),
('Council Approval', 'd', '2025-03-13', '/qac_ugc/qac_ugc/Proposal_sections/uploads/1742064039_1739720192_benchmark.pdf', 28, 13, 7),
...
(10, 3, 2, 'PROP_3_1743622897', 1000.00, 'completed', '2025-04-02 19:41:37', '2025-04-02 19:44:06');
...
(2, 'Senali', 'Siriwardhana', 'a@gmail.com', 'University of Colombo', 'Program Coordinator of the university', 'pccol', '$2y$10$/OYZnsUO5aULjGF7XhEiseNJvqOKbx7JmfOontmLagQDElQC/m1WC', 1),
(3, 'Dr.Rasika', 'Rathnayake', 'rasika@ucsc.ac.lk', 'University of Colombo', 'Dean/Rector/Director of the university', 'deancol', '$2y$10$AZypU4KIY87Uxif4Y8e6Zu5XJPaq9NxlLMqqFCq1z/353q6Rw4mWK', 1),
(5, 'Prof.A', 'Weerasinghe', 'weerasinghe@ucsc.ac.lk', 'University of Colombo', 'Vice Chancellor of the university', 'vccol', '$2y$10$AZypU4KIY87Uxif4Y8e6Zu5XJPaq9NxlLMqqFCq1z/353q6Rw4mWK', 1),
...
(20, 'A', 'B', 'pc@peradeniya.ac.lk', 'University of Peradeniya', 'Program Coordinator of the university', 'pcpera', '$2y$10$RyqGiQ1KHX.NKI1S0v700uxyULce1DsyPLD/x.WLtupFHJlqWUy0u', 3),
(21, 'Dean', 'D', 'dean@peradeniya.ac.lk', 'University of Peradeniya', 'Dean/Rector/Director of the university', 'deanpera', '$2y$10$HuhPdwidOqhrXXEe58P2kusEPTF9b/pNgB6EnVv24ZKL4N0l8IfQG', 3),
(22, 'CQA', 'Director', 'cqa@pera.ac.lk', 'University of Peradeniya', 'CQA Director of the university', 'cqapera', '$2y$10$Xi7XuhsZQlCErcRJVhrDEO7P44oPz0T.er6pyL7UUJKY79DCc4ys.', 3),
(23, 'VC', 'Peradeniya', 'vc@pera.ac.lk', 'University of Peradeniya', 'Vice Chancellor of the university', 'vcpera', '$2y$10$BS0drx9FCGD/LXLkNuosjOKebiyNtK0Ai7r31gKnZYDOUzmuV7IDy', 3);
...
--
ALTER TABLE `proposal_assessment_rules`
  MODIFY `assessment_rule_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `proposal_compliance_check`
  MODIFY `compliance_check_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `proposal_degree_details`
--
ALTER TABLE `proposal_degree_details`
  MODIFY `degree_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `proposal_financial_resource`
--
ALTER TABLE `proposal_financial_resource`
  MODIFY `financial_resource_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `proposal_general_info`
--
ALTER TABLE `proposal_general_info`
  MODIFY `general_info_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `proposal_grades_received`
--
ALTER TABLE `proposal_grades_received`
  MODIFY `program_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;

--
-- AUTO_INCREMENT for table `proposal_human_resource`
--
ALTER TABLE `proposal_human_resource`
  MODIFY `human_resource_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT for table `proposal_mandate_availability`
--
ALTER TABLE `proposal_mandate_availability`
  MODIFY `mandate_availability_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT for table `proposal_panel_of_teachers`
--
ALTER TABLE `proposal_panel_of_teachers`
  MODIFY `teacher_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=260;
...
--
ALTER TABLE `proposal_physical_resource`
  MODIFY `physical_resource_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
...
--
ALTER TABLE `proposal_program_delivery`
  MODIFY `program_delivery_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `proposal_program_entity`
--
ALTER TABLE `proposal_program_entity`
  MODIFY `program_entity_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `proposal_program_structure`
--
ALTER TABLE `proposal_program_structure`
  MODIFY `program_structure_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `proposal_resource_requirements`
--
ALTER TABLE `proposal_resource_requirements`
  MODIFY `resource_requirement_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `proposal_reviewers_report`
--
ALTER TABLE `proposal_reviewers_report`
  MODIFY `report_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
